...
function InfoTooltip(props) {
    return (
        <PopupWithForm className='modal__background modal__background_tooltip' name='tooltip' isOpen={true} onClose={props.onClose}>
            <img className='' src={props.feedback === 'success' ? successIcon : failIcon} alt='success or failure feedback icon' />
